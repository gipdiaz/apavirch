...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Remito.socio'
        db.add_column(u'trazabilidad_remito', 'socio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['trazabilidad.Socio']),
                      keep_default=False)


        # Changing field 'Socio.codigoUnicoIdentif'
        db.alter_column(u'trazabilidad_socio', 'codigoUnicoIdentif', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

    def backwards(self, orm):
        # Deleting field 'Remito.socio'
        db.delete_column(u'trazabilidad_remito', 'socio_id')


        # Changing field 'Socio.codigoUnicoIdentif'
        db.alter_column(u'trazabilidad_socio', 'codigoUnicoIdentif', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
