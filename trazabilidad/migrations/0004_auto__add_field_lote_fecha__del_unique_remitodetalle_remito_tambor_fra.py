...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lote.fecha'
        db.add_column(u'trazabilidad_lote', 'fecha',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 17, 0, 0)),
                      keep_default=False)
        ...
        # Adding field 'Socio.ciudad'
        db.add_column(u'trazabilidad_socio', 'ciudad',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=9100, to=orm['trazabilidad.Ciudad']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Lote.fecha'
        db.delete_column(u'trazabilidad_lote', 'fecha')
        ...
        # Deleting field 'Socio.ciudad'
        db.delete_column(u'trazabilidad_socio', 'ciudad_id')
    ...
    models = {
        ...
        u'trazabilidad.remitodetalle': {
            'Meta': {'unique_together': "(('tambor', 'fraccionamiento'),)", 'object_name': 'RemitoDetalle'},
