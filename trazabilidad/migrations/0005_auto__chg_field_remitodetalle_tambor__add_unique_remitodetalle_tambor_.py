...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RemitoDetalle', fields ['tambor', 'fraccionamiento']
        db.delete_unique(u'trazabilidad_remitodetalle', ['tambor_id', 'fraccionamiento_id'])


        # Changing field 'RemitoDetalle.tambor'
        db.alter_column(u'trazabilidad_remitodetalle', 'tambor_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['trazabilidad.Tambor'], unique=True, null=True))
        # Adding unique constraint on 'RemitoDetalle', fields ['tambor']
        db.create_unique(u'trazabilidad_remitodetalle', ['tambor_id'])


        # Changing field 'RemitoDetalle.fraccionamiento'
        db.alter_column(u'trazabilidad_remitodetalle', 'fraccionamiento_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['trazabilidad.Fraccionamiento'], unique=True, null=True))
        # Adding unique constraint on 'RemitoDetalle', fields ['fraccionamiento']
        db.create_unique(u'trazabilidad_remitodetalle', ['fraccionamiento_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RemitoDetalle', fields ['fraccionamiento']
        db.delete_unique(u'trazabilidad_remitodetalle', ['fraccionamiento_id'])

        # Removing unique constraint on 'RemitoDetalle', fields ['tambor']
        db.delete_unique(u'trazabilidad_remitodetalle', ['tambor_id'])


        # Changing field 'RemitoDetalle.tambor'
        db.alter_column(u'trazabilidad_remitodetalle', 'tambor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trazabilidad.Tambor'], null=True))

        # Changing field 'RemitoDetalle.fraccionamiento'
        db.alter_column(u'trazabilidad_remitodetalle', 'fraccionamiento_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trazabilidad.Fraccionamiento'], null=True))
        # Adding unique constraint on 'RemitoDetalle', fields ['tambor', 'fraccionamiento']
        db.create_unique(u'trazabilidad_remitodetalle', ['tambor_id', 'fraccionamiento_id'])
    ...
    models = {
        ...
        u'trazabilidad.activo': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
        ...
        u'trazabilidad.apiario': {
            ...
            'fechaAlta': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
        ...
        u'trazabilidad.remitodetalle': {
            ...
            'fraccionamiento': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['trazabilidad.Fraccionamiento']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'tambor': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['trazabilidad.Tambor']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
