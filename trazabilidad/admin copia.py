...
class CiudadAdmin(CustomModelAdmin):
    list_display = ('descripcion', 'codigoPostal', 'added_by')
...
## ----------------------------------- ##
admin.site.register(GrupoAlza, GrupoAlzaAdmin)
admin.site.register(TipoAlza, CustomPermissionAdmin)
admin.site.register(Apiario, CustomPermissionAdmin)
admin.site.register(Ciudad, CiudadAdmin)
admin.site.register(Direccion, CustomPermissionAdmin)
admin.site.register(TipoDocumento, CustomPermissionAdmin)
admin.site.register(TipoEnvase, CustomPermissionAdmin)
...
admin.site.register(RemitoDetalle)
